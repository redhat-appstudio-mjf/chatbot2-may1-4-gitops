...
# Application
An application built from https://github.com/redhat-appstudio-mjf/chatbot2-may1-4 will be stored in [quay.io/maysunfaisal/chatbot2-may1-4](https://quay.io/maysunfaisal/chatbot2-may1-4) and deployed through GitOps. This application is accessible on port **8501**.